...
export declare const SETTINGS_NS = "skill-manager";
...
export declare const WORK_DIR = ".skill-manager";
/** User-level skill root scanned by the harness (`<dshHome>/skills`). */
export declare const USER_SKILLS_DIR = "skills";
/** Rank for the `.claude/skills` compatibility provider candidates. */
export declare const CLAUDE_COMPAT_RANK = 250;
/** Provider name registered on `ctx.skills`. */
export declare const CLAUDE_COMPAT_PROVIDER = "skill-manager-claude";
/** Source label attached to compatibility candidates. */
export declare const CLAUDE_COMPAT_SOURCE = "compat-claude";
