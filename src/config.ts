...
const resultSchema = z.object({
  ...
  message: z.string(),
  data: z.string(),
}) as unknown as z<WireResult>

/** Runtime schema for the whole {@link WireSection}. */
export const Config: z<WireSection> = z.object({
  proxy: z.object({
...
export function defaultConfig(): WireSection {
  return {
 ...
 */
export function assertValidConfig(section: WireSection): void {
...
export function proxyConfig(section: WireSection): ProxyConfig {
